...
- Lower coupling, less problems, DialogX can close the Activity** while the dialog box is running without worrying about the WindowLeaked error caused by previous components such as AlertDialog.
